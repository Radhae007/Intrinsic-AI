...
#include "aic_control_interfaces/msg/detail/trajectory_generation_mode__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const aic_control_interfaces::msg::TrajectoryGenerationMode & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aic_control_interfaces::msg::TrajectoryGenerationMode & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aic_control_interfaces::msg::TrajectoryGenerationMode;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const aic_control_interfaces::msg::TrajectoryGenerationMode *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aic_control_interfaces::msg::TrajectoryGenerationMode *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TrajectoryGenerationMode__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const aic_control_interfaces::msg::TrajectoryGenerationMode *>(
...
static size_t _TrajectoryGenerationMode__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TrajectoryGenerationMode(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TrajectoryGenerationMode__callbacks = {
...
static rosidl_message_type_support_t _TrajectoryGenerationMode__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TrajectoryGenerationMode__callbacks,
...
{
  return &aic_control_interfaces::msg::typesupport_fastrtps_cpp::_TrajectoryGenerationMode__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aic_control_interfaces, msg, TrajectoryGenerationMode)() {
  return &aic_control_interfaces::msg::typesupport_fastrtps_cpp::_TrajectoryGenerationMode__handle;
}
