...
#include "aic_control_interfaces/msg/detail/motion_update__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const aic_control_interfaces::msg::TrajectoryGenerationMode &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
size_t get_serialized_size(
  ...
  size_t current_alignment);
size_t
max_serialized_size_TrajectoryGenerationMode(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
bool cdr_serialize_key(
...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_TrajectoryGenerationMode(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
cdr_serialize(
  const aic_control_interfaces::msg::MotionUpdate & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aic_control_interfaces::msg::MotionUpdate & ros_message)
{
  // Member: header
  ...
  // Member: feedforward_wrench_at_tip
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.feedforward_wrench_at_tip);
  ...
  aic_control_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.trajectory_generation_mode);
  ...
  size_t current_alignment)
{
  ...
  // Member: target_stiffness
  {
    ...
    size_t item_size = sizeof(ros_message.target_stiffness[0]);
  ...
  {
    size_t array_size = 36;
    size_t item_size = sizeof(ros_message.target_damping[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  {
    size_t array_size = 6;
    size_t item_size = sizeof(ros_message.wrench_feedback_gains_at_tip[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_aic_control_interfaces
max_serialized_size_MotionUpdate(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: trajectory_generation_mode
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        aic_control_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_TrajectoryGenerationMode(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = aic_control_interfaces::msg::MotionUpdate;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_aic_control_interfaces
max_serialized_size_key_MotionUpdate(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: trajectory_generation_mode
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        aic_control_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_key_TrajectoryGenerationMode(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const aic_control_interfaces::msg::MotionUpdate *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aic_control_interfaces::msg::MotionUpdate *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MotionUpdate__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const aic_control_interfaces::msg::MotionUpdate *>(
...
static size_t _MotionUpdate__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MotionUpdate(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MotionUpdate__callbacks = {
...
static rosidl_message_type_support_t _MotionUpdate__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MotionUpdate__callbacks,
...
{
  return &aic_control_interfaces::msg::typesupport_fastrtps_cpp::_MotionUpdate__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aic_control_interfaces, msg, MotionUpdate)() {
  return &aic_control_interfaces::msg::typesupport_fastrtps_cpp::_MotionUpdate__handle;
}
