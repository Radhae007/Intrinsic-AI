...
#ifndef AIC_CONTROL_INTERFACES__MSG__MOTION_UPDATE_H_
#define AIC_CONTROL_INTERFACES__MSG__MOTION_UPDATE_H_
...
#endif  // AIC_CONTROL_INTERFACES__MSG__MOTION_UPDATE_H_
