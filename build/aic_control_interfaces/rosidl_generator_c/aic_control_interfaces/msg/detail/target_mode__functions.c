...
aic_control_interfaces__msg__TargetMode__create(void)
{
  ...
  aic_control_interfaces__msg__TargetMode * msg = (aic_control_interfaces__msg__TargetMode *)allocator.allocate(sizeof(aic_control_interfaces__msg__TargetMode), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(aic_control_interfaces__msg__TargetMode));
  bool success = aic_control_interfaces__msg__TargetMode__init(msg);
  if (!success) {
...
aic_control_interfaces__msg__TargetMode__destroy(aic_control_interfaces__msg__TargetMode * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    aic_control_interfaces__msg__TargetMode__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
aic_control_interfaces__msg__TargetMode__Sequence__init(aic_control_interfaces__msg__TargetMode__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aic_control_interfaces__msg__TargetMode * data = NULL;

  if (size) {
    data = (aic_control_interfaces__msg__TargetMode *)allocator.zero_allocate(size, sizeof(aic_control_interfaces__msg__TargetMode), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = aic_control_interfaces__msg__TargetMode__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        aic_control_interfaces__msg__TargetMode__fini(&data[i - 1]);
      }
...
aic_control_interfaces__msg__TargetMode__Sequence__fini(aic_control_interfaces__msg__TargetMode__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      aic_control_interfaces__msg__TargetMode__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  aic_control_interfaces__msg__TargetMode__Sequence * array = (aic_control_interfaces__msg__TargetMode__Sequence *)allocator.allocate(sizeof(aic_control_interfaces__msg__TargetMode__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = aic_control_interfaces__msg__TargetMode__Sequence__init(array, size);
  if (!success) {
...
aic_control_interfaces__msg__TargetMode__Sequence__destroy(aic_control_interfaces__msg__TargetMode__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    aic_control_interfaces__msg__TargetMode__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
aic_control_interfaces__msg__TargetMode__Sequence__are_equal(const aic_control_interfaces__msg__TargetMode__Sequence * lhs, const aic_control_interfaces__msg__TargetMode__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!aic_control_interfaces__msg__TargetMode__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  aic_control_interfaces__msg__TargetMode__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(aic_control_interfaces__msg__TargetMode);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    aic_control_interfaces__msg__TargetMode * data =
      (aic_control_interfaces__msg__TargetMode *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!aic_control_interfaces__msg__TargetMode__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          aic_control_interfaces__msg__TargetMode__fini(&output->data[i]);
        }
        return false;
      }
    }
