...
#include "aic_task_interfaces/msg/detail/task__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const aic_task_interfaces::msg::Task & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: cable_type
  cdr << ros_message.cable_type;

  // Member: cable_name
  cdr << ros_message.cable_name;

  // Member: plug_type
  cdr << ros_message.plug_type;

  // Member: plug_name
  cdr << ros_message.plug_name;

  // Member: port_type
  cdr << ros_message.port_type;

  // Member: port_name
  cdr << ros_message.port_name;

  // Member: target_module_name
  cdr << ros_message.target_module_name;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aic_task_interfaces::msg::Task & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aic_task_interfaces::msg::Task;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const aic_task_interfaces::msg::Task *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aic_task_interfaces::msg::Task *>(
    untyped_ros_message);
...
get_message_type_support_handle<aic_task_interfaces::msg::Task>()
{
  return &aic_task_interfaces::msg::typesupport_fastrtps_cpp::_Task__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aic_task_interfaces, msg, Task)() {
  return &aic_task_interfaces::msg::typesupport_fastrtps_cpp::_Task__handle;
}
