...
static const _Task_type_support_symbol_names_t _Task_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aic_task_interfaces, msg, Task)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aic_task_interfaces, msg, Task)),
  }
};
...
{
  return &::aic_task_interfaces::msg::rosidl_typesupport_cpp::Task_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, aic_task_interfaces, msg, Task)() {
  return get_message_type_support_handle<aic_task_interfaces::msg::Task>();
}
